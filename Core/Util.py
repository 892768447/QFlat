...
if PY3:
    from inspect import getfullargspec as getargspec  # @UnusedImport
else:
    from inspect import getargspec  # @Reimport
...
if PY3:
    ...
    unicode_type = unicode  # noqa @UndefinedVariable
    basestring_type = basestring  # noqa @UndefinedVariable


try:
    import typing  # noqa
    from typing import cast  # @UnusedImport
    ...
    import datetime  # noqa @UnusedImport
    import types  # noqa @UnusedImport
    from typing import Any, AnyStr, Union, Optional, Dict, Mapping  # noqa @UnusedImport
    from typing import Tuple, Match, Callable  # noqa @UnusedImport
